...
function VersionPage() {
  ...
  return (
    <Layout title="Versions" description="Nocalhost Versions Page">
      <main className="container margin-vert--lg">
        <h1>
          <Translate>Nocalhost documentation versions</Translate>
        </h1>
      ...
      {pastVersions.length > 0 && (
        <div className="margin-bottom--lg">
          <h3 id="archive">
            <Translate>Past version (Not maintained anymore)</Translate>
          </h3>
          <p>
